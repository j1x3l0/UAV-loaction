...
class TaskAwareCriticDataset:
    def __init__(self, batch_size, obs, vlm_feature, target_values, shuffle=False, drop_last=False):
        # Flatten [T, B, ...] to [T * B, ...]
        self.obs = obs.view(-1, obs.shape[-1])
        self.vlm_feature = vlm_feature.view(-1, vlm_feature.shape[-1])
    ...
    def shuffle(self):
        ...
        self.vlm_feature = self.vlm_feature[index, :]
    ...
    def __getitem__(self, index):
        ...
        return {
            ...
            'vlm': self.vlm_feature[start_idx:end_idx, :],
