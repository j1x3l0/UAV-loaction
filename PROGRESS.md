...
| V3-Weighted-Scale | 🔵 3×500 训练中 | gate_mid | 2026-07-28 07:14 | — | 服务器 `saved_models/v3_scale_weighted_3x500_20260728_071450/` |
...
V3-Weighted-Scale 已按 `1.0/0.75/0.5/0.25/0.1× =
20%/20%/40%/10%/10%` 启动三个训练 seed。服务器测试确认 16/16
通过，2,000 次采样中 0.5× 占 40.0%。训练完成后按完全相同的
五档 × 200 episodes 协议验收。
